...
total_points = len(mat_sp) * len(C_sp) * l_sp**5 * cell_sp**2 * r_sp**2 * v_sp**3
                                            ...
                                            for veo in ve_sp:
                                                for ven in ve_sp:
                                                    for mat in mat_sp:
                                                        ...
                                                        #oFn, cFn, sim_time, fail = ([1,2,3,4], [5,6], 7, False)
                                                        ...
                                                        print(f'Done {count} out of {total_points} total points in {files} files.')
